 ...
 * Perfection, WorkSuite) means adding its module here - no core changes.
 */
@Module({
  imports: [SqlServerModule, SageX3Module],
  controllers: [IntegrationHealthController],
  providers: [IntegrationRegistry],
  exports: [IntegrationRegistry, SqlServerModule, SageX3Module],
})
